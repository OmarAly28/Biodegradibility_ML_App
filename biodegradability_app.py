...
if master:
    df1 = pd.read_csv("C:\\Users\\oaly2\\Downloads\\option_1.csv", low_memory=False, na_filter=False) # -------------------- #
    df2 = pd.read_csv("C:\\Users\\oaly2\\Downloads\\option_2.csv", low_memory=False, na_filter=False) # -------------------- #
    df3 = pd.read_csv("C:\\Users\\oaly2\\Downloads\\option_3.csv", low_memory=False, na_filter=False) # -------------------- #
    df4 = pd.read_csv("C:\\Users\\oaly2\\Downloads\\option_4.csv", low_memory=False, na_filter=False) # -------------------- #
else:
